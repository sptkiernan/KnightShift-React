                  ...
                  <div className="product-card-bottom">
                    ...
                    <button
                      className={`btn add-cart-btn${
                        addedId === product.id ? " btn-success-flash" : " btn-brand"
                      }`}
          ...
          <div className="row g-4">
            ...
            <div className="col-12 col-lg-4">
              <div className="info-card h-100">
                ...
                <div className="summary-row">
                  <span>Shipping</span>
                  <span id="shippingCost">${shipping.toFixed(2)}</span>
                </div>
                <hr />
                <div className="summary-row">
                  <span>Total</span>
                ...
                {items.length === 0 ? (
                  ...
                  <>
                    ...
                    >
                      <span>Ship to:</span>
                      <span>
                        {shippingForm.address || "No address entered"}
                      </span>
                    </div>
                    <div className="summary-row">
                      <span>Email:</span>
              ...
              <div style={{ marginTop: "1.25rem" }}>
                ...
                {orderHistory.map((order) => (
                  ...
                  >
                    ...
                    <p
                      className="price"
                      style={{ margin: "0.5rem 0 0", fontSize: "1rem" }}
                    >
