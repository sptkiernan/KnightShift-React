    ...
    <>
      <section className="hero">
        <div className="container">
          ...
          <p className="hero-text">
            ...
            orders, or brewing, you’ll find quick answers below—or you can
          ...
          <div className="row g-4">
            <div className="col-12 col-md-6">
              <div className="step-card h-100 support-feature-card">
                <h3>Processing</h3>
                <p>
                  Orders are typically processed within 1–2 business days. You
                  will receive a confirmation email once your order has been
                  placed and another when it ships.
                </p>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6">
              <div className="step-card h-100 support-feature-card">
                <h3>Returns</h3>
                <p>
                  Because coffee is perishable, unopened accessory items can be
                  returned within 30 days, while coffee issues are handled
                  case-by-case through support.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="section section-light">
        <div className="container">
          ...
          <p>
            ...
            information. Knight Shift Coffee only collects the information
            needed to process orders, respond to inquiries, and improve your
            experience on our site.
          </p>

          <p>
            We may collect basic information such as your name, email address,
            and order details when you make a purchase or contact us. This
            information is used only to fulfill your request or provide
            support.
          </p>

          <p>
            We do not sell or share your personal information with third
            parties, except when necessary to process orders, such as shipping
            providers.
          </p>

          <p>
            Our site may use basic cookies to improve functionality and
            understand how users interact with the site. You can disable
            cookies in your browser settings if you prefer.
          </p>

          <p>
            If you have any questions about your data or how it is used, please
            contact us.
          </p>
        </div>
      </section>
      ...
      <section className="section section-light">
        <div className="container">
          ...
          <p>
            We designed this site to be clear, readable, and easy to navigate
          ...
          <div className="info-card accessibility-note">
            ...
            <p className="mb-0">
              We recognize that accessibility is an ongoing process, and we
              would continue improving the experience based on user feedback and
              testing.
            </p>
          </div>
        </div>
